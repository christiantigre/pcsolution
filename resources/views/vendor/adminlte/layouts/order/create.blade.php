      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              {!! Form::text('modelo',null,['class'=>'form-control','autocomplete'=>'off','autofocus'=>'autofocus','placeholder'=>'']) !!}
            </div>
          </div>
          <!-- /.form-group -->
          <!--serie-->            
        ...
        <div class="col-md-4">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              {!! Form::text('ci_cli',null,['id'=>'ci_cli','class'=>'form-control','autocomplete'=>'off','autofocus'=>'autofocus','placeholder'=>'']) !!}
            </div>
          </div>
          <!-- /.form-group -->
          <!--telefono cliente-->            
        ...
        <div class="col-md-12"> 
          ...
          <div class="form-group">
           ...
           <div class="col-sm-10">
            {!! Form::text('problema',null,['class'=>'form-control','autocomplete'=>'off','placeholder'=>'']) !!}
          </div>
        </div>
      </div>
      <div class="col-md-12">           
       ...
       <div class="form-group">
         ...
         <div class="col-sm-10">
          {!! Form::text('notas',null,['class'=>'form-control','autocomplete'=>'off','placeholder'=>'']) !!}
        </div>
      </div>
    </div>
  </div>
