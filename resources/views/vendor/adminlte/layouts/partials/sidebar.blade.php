        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview">
                        <a href="#"><i class='fa fa-link'></i> <span>{{ trans('message.parametros') }}</span> <i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                    ...
                    <li class="treeview">
                    <a href="#"><i class='fa fa-link'></i> <span>{{ trans('message.regiones') }}</span> <i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
